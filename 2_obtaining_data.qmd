...
[^2_obtaining_data-11]: The different options of the [g.region]{.style-function} function provide a lot of flexibility in to how to define the region. You are encouraged to carefully consider the different options each time you use this module.
