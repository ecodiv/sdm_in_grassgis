...
=======
We'll download and import a few base layers, including maps of the national boundaries, roads, rivers, and land use. While these layers could potentially be used as inputs for modeling, in this tutorial they will serve only as reference layers[^2_obtaining_data-2]. 

[^2_obtaining_data-2]: *Reference layers* are datasets that provide context and help you to visually navigate the map and understand the geographic setting of the area being analyzed. One of the key advantages of modeling in a GIS environment is the ability to seamlessly integrate and compare model outcomes with these reference layers, and thus to explore and interpret results in their geographic context.

::: {.callout-tip appearance="simple"}
The steps in this section provide a practical, hands-on introduction to basic data processing within the GRASS environment for new comers. However, if your main interest lies in the Maxent modeling itself, you may choose to skip this section and simply [download the SDM.zip](https://nx66306.your-storageshare.de/s/sLBsLt9xjK75bCx). Extract the file into your GRASS database directory. This will replace the SDM directory you created earlier in @sec-creatingadatabase.
>>>>>>> origin/main
:::
