...
The steps in this section provide a practical, hands-on introduction to basic data processing within the GRASS environment for new comers. 

If your main interest lies in the Maxent modeling itself, you may choose to skip this section and simply [download the SDM project](https://nx66306.your-storageshare.de/s/7R3Eewybi6zfSyw) as a zip file. Extract the file into your GRASS database directory. This will replace the SDM directory you created earlier in @sec-creatingadatabase.
:::
