...
::: {.callout-tip icon="false"}
## {{< iconify streamline-freehand business-deal-handshake size=huge >}} Acknowledgement

This tutorial is part of a course on species distribution modeling at the [HAS Green Academy](https://has.nl), developed with input from the [Innovative Biomonitoring](https://www.has.nl/en/research/professorships/innovative-bio-monitoring-professorship/) and [Climate-robust Landscapes](https://www.has.nl/en/research/professorships/climate-robust-landscapes-professorship/) research groups, drawing on their ongoing work and expertise.
:::
