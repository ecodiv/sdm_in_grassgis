...
Users are also assumed to be familiar with GRASS GIS. If not, see [Appendix A](A1_grassbasics.qmd) for a quick introduction, and check out the list of introductory and advanced [tutorials](https://grass.osgeo.org/learn/tutorials/) and courses. And if you have questions or got stuck, see if the [GRASS GIS community](https://grass.osgeo.org/support/community/) can help you out.
